                    ...
                    if (appointment.status == 'pending' || appointment.status == 'approved') ...[
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          await ref.read(appointmentProvider.notifier).cancelAppointment(appointment.id);
                          final notificationsPlugin = FlutterLocalNotificationsPlugin();
                          await notificationsPlugin.show(
                            0,
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          await ref.read(appointmentProvider.notifier).completeAppointment(appointment.id);
                          final notificationsPlugin = FlutterLocalNotificationsPlugin();
                          await notificationsPlugin.show(
                            0,
